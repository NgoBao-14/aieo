...
@Component({
  selector: 'app-listening-multi-select-group',
  templateUrl: './listening-multi-select-group.component.html',
  styleUrls: ['./listening-multi-select-group.component.scss']
})
export class ListeningMultiSelectGroupComponent {
