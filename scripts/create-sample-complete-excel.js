...
/**
 * Create complete sample Excel with REAL data
 * Shows exactly what a full test looks like
 */
...
console.log('📝 Creating complete sample Excel...\n');

// ============================================
// COMPLETE READING TEST EXAMPLE
// ============================================

const sampleData = [
  // ===== TEST METADATA (stays in DB, not JSON) =====
  {
  ...
  // ===== PART 1 =====
  {
    ...
    passage_html: `<div class='passage-section'>
...
<div class='passage-section'>
  <span class='p-label'>Paragraph C</span>
...
<div class='passage-section'>
  <span class='p-label'>Paragraph D</span>
...
<div class='passage-section'>
  <span class='p-label'>Paragraph E</span>
...
<div class='passage-section'>
  <span class='p-label'>Paragraph F</span>
  ...
  // ===== QUESTION GROUP 1: Note Completion =====
  {
    ...
    group_range: '1-8',
    group_instructions: 'Complete the notes below. Choose ONE WORD ONLY from the passage for each answer. Write your answers in boxes 1–8.',
...
<ul>
  ...
  <li>Silk used as a form of ((5)) — e.g. farmers paid taxes in silk</li>
  <li>Evidence found that ((6)) was made from silk as early as 168 AD</li>
</ul>
...
<ul>
  ...
  <li>Around 550 AD — two ((8)) smuggled silkworm eggs out of China hidden in bamboo canes</li>
</ul>`
  },
  { section: '' },

  // Questions for Group 1
  { section: 'QUESTIONS', q_id: 1, q_text: '', answer: 'tea', explanation: 'She picked tea out of her cup when a cocoon fell in' },
  ...
  { section: 'QUESTIONS', q_id: 5, q_text: '', answer: 'currency', explanation: 'Silk used as currency to pay taxes' },
  { section: 'QUESTIONS', q_id: 6, q_text: '', answer: 'paper', explanation: 'Evidence found that paper was made from silk by 168 AD' },
  ...
  // ===== QUESTION GROUP 2: True/False/Not Given =====
  {
    ...
    group_range: '9-13',
    group_instructions: 'Do the following statements agree with the information given in Reading Passage 1? Write TRUE, FALSE or NOT GIVEN in boxes 9–13.',
    template_html: ''
  },
  { section: '' },
  ...
  { section: 'QUESTIONS', q_id: 10, q_text: 'Gold was the most valuable material transported along the Silk Road.', option_a: 'TRUE', option_b: 'FALSE', option_c: 'NOT GIVEN', answer: 'FALSE', explanation: 'Passage mentions wool and precious metals, not gold as most valuable' },
  { section: 'QUESTIONS', q_id: 11, q_text: 'Roman women wore more silk than Roman men.', option_a: 'TRUE', option_b: 'FALSE', option_c: 'NOT GIVEN', answer: 'NOT GIVEN', explanation: 'Passage does not mention gender differences in silk wearing' },
  { section: 'QUESTIONS', q_id: 12, q_text: 'The monks who took silk to Constantinople were sent by Emperor Justinian I.', option_a: 'TRUE', option_b: 'FALSE', option_c: 'NOT GIVEN', answer: 'TRUE', explanation: 'Emperor Justinian I sent them to China as spies' },
  { section: 'QUESTIONS', q_id: 13, q_text: 'Natural silk is still used today in medical applications.', option_a: 'TRUE', option_b: 'FALSE', option_c: 'NOT GIVEN', answer: 'TRUE', explanation: 'Passage states natural silk is preferred for medical applications' }
];

const wb = XLSX.utils.book_new();
XLSX.utils.book_append_sheet(wb, XLSX.utils.json_to_sheet(sampleData), 'Reading Test');

const filePath = path.join(excelDir, 'SAMPLE-COMPLETE-Reading.xlsx');
XLSX.writeFile(wb, filePath);

console.log(`✅ Created: ${filePath}`);
console.log('\n📋 This file shows:');
console.log('✓ TEST_METADATA (stored in DB, not in JSON)');
console.log('✓ PART with full passage HTML');
console.log('✓ QUESTION_GROUP 1: Note Completion (with template)');
console.log('✓ QUESTION_GROUP 2: True/False/Not Given');
console.log('✓ All 13 questions with answers & explanations');
console.log('\n🔍 Check the file to see exactly what a complete test looks like!');
